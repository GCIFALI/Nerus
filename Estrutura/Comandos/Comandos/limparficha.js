            ...
            verificarcargopolicia.once('value', async (snapshot) => {
                ...
                verificarcargoadvogado.once('value', async (snapshot) => {
                    ...
                    if (cargopolicia == null || cargoadvogado == null) {
                        ...
                        .setAuthor("Nerus - Limpeza de Ficha","https://media.discordapp.net/attachments/807079371768070144/826834705537826867/96x96.png")
                        .setColor(`#750dbb`)
                    ...
                    if (message.member.roles.cache.has(cargopolicia || cargoadvogado)) {
                        if (message.member.roles.cache.has(cargopolicia)) {
                            ...
                            .setColor(`#750dbb`)
                            .setAuthor("Nerus - Sistema de Limpeza de Ficha", "https://media.discordapp.net/attachments/807079371768070144/826834705537826867/96x96.png")
                            .setDescription(`Mencione ou envie o ID do usuário que você deseja limpar a ficha.`)
                            ...
                            let localizarficha = database.ref(`servidores/${message.guild.id}/roleplayconsole/fichas/${idusuario}`);
                            localizarficha.once('value', (snapshot) => {
                                ...
                                if (data == null) {
                                    mainMsg.edit(
                                        ...
                                        .setDescription(`Negado, não existe nenhuma ficha criminal deste usuário em meu banco de dados <a:CheckVermelho:817107349306474547>`)
                                        .setFooter("Atenciosamente, Nerus.")
                                    );
                                } else {
                                    let limparficha = database.ref(`servidores/${message.guild.id}/roleplayconsole/fichas/${idusuario}`);
                                    limparficha.remove()
                                    mainMsg.edit(
                                        new Discord.MessageEmbed()
                                        .setAuthor("Nerus - Limpeza de Ficha","https://media.discordapp.net/attachments/807079371768070144/826834705537826867/96x96.png")
                                        .setColor(`#750dbb`)
                                        .setDescription(`Ficha limpa com sucesso <a:CheckVerde:817107349881618442>\n\n<a:sireneazul:820334680003575809> **Solicitador:** ${message.author}\n📁 **Usuário que teve a sua ficha limpa:** <@!${idusuario}>`)
