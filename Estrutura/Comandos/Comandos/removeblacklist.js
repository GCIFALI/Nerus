...
module.exports = {
    run: async (client, message, args) => {
        ...
        .setColor(`#750dbb`)
        .setAuthor("Nerus - Remove Blacklist","https://media.discordapp.net/attachments/807079371768070144/826834705537826867/96x96.png")
        .setDescription("Olá papai, envie por favor o ID da pessoa que você quer remover da blacklist de usuários <a:Loading:817110188002770976>")
          ...
          .then((collected) => {
            ...
            if (msg[0] === "parar" || msg[0] === "cancelar") {
                mainMsg.edit(
                    ...
                    .setTitle("Nerus - Remove Blacklist")
                    .setColor(`#750dbb`)
