        ...
        localizarnomedinheirosujo.once('value',async (snapshot) => {
            ...
            if (data == null) {
                ...
                if (delaycaixinha.has(message.guild.id)){
                    ...
                    .setAuthor("Nerus - Sistema de Hackeamento de Caixa Eletrônico","https://media.discordapp.net/attachments/807079371768070144/826834705537826867/96x96.png")
                    .setColor(`#750dbb`)
                    .setDescription(`Negado, os caixas eletrônicos não se recuperaram ainda do ultimo roubo. Aguarde 10 minutos e tente novamente <a:CheckVermelho:817107349306474547>`)
                    .setFooter("Atenciosamente, Nerus")
                ...
                checaritem2.once('value',async (snapshot) => {
                    ...
                    if (verificaitem !== null && cargopolicia !== null){
                        if (!message.member.roles.cache.has(cargopolicia)) {
                            ...
                            const valoraletorio = Math.floor(Math.random() * 2500) + 1500;
                            if (valorparafail) {
                                setTimeout(function(){ 
                                    mainMsg.edit(
                                        new Discord.MessageEmbed()
                                        .setColor(`#750dbb`)
                                        .setAuthor("Nerus - Sistema de Hackeamento de Caixa Eletrônico","https://media.discordapp.net/attachments/807079371768070144/826834705537826867/96x96.png")
                                        .setDescription(`Sucesso, por pouco que não consigo quebrar o firewall do caixa eletrônico <a:checkverde:817107349881618442>\n**Este Roubo Rendeu:** R$ ${valoraletorio},00 em dinheiro sujo `)
                                        .setImage("https://media.discordapp.net/attachments/807079371768070144/825017265203314718/giphy.gif")
                                        .setFooter("Atenciosamente, Nerus.")
                                    )
