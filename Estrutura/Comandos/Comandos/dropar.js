    ...
    run: async (client, message, args) => {
        ...
        localizaritens.once('value', async (snapshot) => {
            ...
            if (data == null){
                ...
                .setColor(`#750dbb`)
                .setAuthor("Nerus - Sistema de Dropagem de Itens", "https://media.discordapp.net/attachments/807079371768070144/826834705537826867/96x96.png")
            ...
            .setColor(`#750dbb`)
            .setAuthor("Nerus - Sistema de Dropagem de Itens", "https://media.discordapp.net/attachments/807079371768070144/826834705537826867/96x96.png")
            .setDescription(`**Qual item** você deseja dropar?`)
            ...
            .then((collected) => {
                msg = collected.first().content.toUpperCase().trim().split(/ +/g)
            ...
            mainMsg.edit(
                ...
                .setColor(`#750dbb`)
                .setAuthor("Nerus - Sistema de Dropagem de Itens", "https://media.discordapp.net/attachments/807079371768070144/826834705537826867/96x96.png")
                .setDescription(`Qual é a quantidade que você deseja dropar ?`)
                .addField(`<a:CheckVermelho:817107349306474547> Deseja cancelar esta operação ?`, `Digite: \`cancelar\``)
                .addField("<:bolsa:820733064590000198> Sua Mochila:",`${data3}`)
                .setThumbnail("https://media.discordapp.net/attachments/807079371768070144/821730141360881674/NERUS_BOT.gif")
            );
            ...
            let verifica = Number(`${msg2[0]}`)
            if (!verifica || msg2[0] == 0) {
                mainMsg.edit(
                    new Discord.MessageEmbed()
                    .setColor(`#750dbb`)
                    .setAuthor("Nerus - Sistema de Dropagem de Itens", "https://media.discordapp.net/attachments/807079371768070144/826834705537826867/96x96.png")
            ...
            if (msg2[0] <= checar2){
                if (msg2[0] >= 1){
                    ...
                    atualizarvalorautor.once('value', (snapshot) => {
                        ...
                        localizarprefixo.once('value', (snapshot) => {
                            ...
                            mainMsg.edit(
                                new Discord.MessageEmbed()
                                .setColor(`#750dbb`)
                                .setAuthor("Nerus - Sistema de Envio de Dropagem de Itens", "https://media.discordapp.net/attachments/807079371768070144/826834705537826867/96x96.png")
                                .setDescription(`Sucesso, você jogou no chão \`${msg[0]} X${msg2[0]}\` <a:CheckVerde:817107349881618442>
                    ...
                    mainMsg.edit(
                        ...
                        .setColor(`#750dbb`)
                        .setAuthor("Nerus - Sistema de Dropagem de Itens", "https://media.discordapp.net/attachments/807079371768070144/826834705537826867/96x96.png")
                        .setDescription(`Negado, vem bugar com número negativo aqui não espertinho <a:CheckVermelho:817107349306474547>\n<a:sirenevermelha:820334439161659492> Meu criador foi avisado sobre isso, não se assuste se você entrar na **blacklist** (:`)
                        .setFooter("Atenciosamente, Nerus.")     
                    );
                    let logcomandos = new Discord.MessageEmbed()
                    .setTitle("Nerus - Log Sistema de Dropagem")
                    .setColor(`#750dbb`)
                    ...
                    .addFields(
                        ...
                        { name: `Valor tentando bugar:`, value: `- ${msg2[0]}`}       
                    )
                    .setTimestamp()
                    .setFooter("Atenciosamente, Nerus.")
